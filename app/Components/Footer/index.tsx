...
const Footer = () => {
  return (
    <footer className="w-full py-10 px-10 flex flex-col items-center justify-center bg-laranja-200">
      <div className="w-auto flex-flex-col items-start  lg:flex-row lg:justify-between ">
        <div className="w-auto flex flex-col items-start">
          ...
          <nav className="flex flex-col items-start gap-2 text-azul-800 font-roboto font-medium">
            ...
            <div className="w-full flex gap-2 items-center mt-2">
              <RiInstagramFill className="text-azul-800 text-3xl" />
              <FaFacebookSquare className="text-azul-800 text-3xl" />
              <AiFillTikTok className="text-azul-800 text-3xl" />
            </div>
          </nav>
        </div>

        <h2 className="font-poetsenOne text-2xl text-azul-800 mt-10">
