...
const SignUpContainer = () => {
  return (
    <div className="w-full min-h-screen h-full px-4 flex flex-col items-center bg-blob lg:bg-blob-lg lg:bg-cover ">
      ...
      <div className="w-full h-auto py-6 flex flex-col items-center justify-center gap-4 lg:w-auto ring-2 ring-azul-900/60 shadow-lg shadow-azul-800 px-10  rounded-md">
