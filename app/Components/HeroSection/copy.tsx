const Copy = () => {
  return (
    <div className="w-full h-auto px-4 flex items-center flex-col gap-6 lg:max-w-[50%] lg:h-full lg:w-auto lg:px-0 lg:py-24">
      <h1 className="font-poetsenOne px-4 text-5xl text-white leading-tight lg:px-0">
      ...
      <p className="font-poppins italic text-2xl lg:text-3xl text-white leading-normal">
        Conecte-se com{" "}
        <span className="underline">especialistas em terapia assistida</span>{" "}
        por animais perto de você!
      </p>
      <div className="flex flex-col gap-10  mt-10 lg:flex-row lg:gap-0">
        <button
          className="w-full px-10 py-3 mr-[77px] bg-laranja-200 text-azul-800 rounded-xl font-bold border-2 border-laranja-200 
